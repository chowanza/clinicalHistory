...
export const createPatientsRequest = async (patient) =>
  axios.post('/tasks', patient)
export const updatePatientsRequest = async (patient) =>
  axios.put(`/tasks/${patient._id}`, patient)
