...
const ImportExcelModal = ({ onClose, onImport }) => {
  ...
  const processExcelData = (data) => {
    ...
    const mapping = {
      ...
      'INFORMES MEDICOS ENTREGADOS': (value) => ({ medicalInformShared: value }),
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      const sheetName = workbook.SheetNames.find(name => 
        name.includes('HISTORIA') || name.includes('DATOS')
  ...
  return (
    <div className="p-6 dark:bg-slate-800 bg-white rounded-lg h-full max-w-2xl mx-auto">
      ...
      <div className="mb-4">
        ...
        <p className="text-xs text-gray-500 mt-1">
          Asegúrate que el archivo tenga el formato correcto con los campos de historia clínica
        </p>
      </div>
