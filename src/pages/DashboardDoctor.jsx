...
const DashboardDoctor = () => {
  ...
  return (
    <main className='relative min-h-[calc(100vh-5rem)] bg-background-light text-text-light dark:bg-background-dark dark:text-text-dark px-4 md:px-24 py-5'>
      ...
      <Modal isOpen={modalState.import} onClose={closeModals}>
        <ImportExcelModal onClose={closeModals} onImport={handleExcelImport} />
      </Modal>
